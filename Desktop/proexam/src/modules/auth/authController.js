const User = require("./src/auth/authModel")  //importigng user model 
const hashedPassword = require("../../utils/hashPassword")  //importing hashed password function
const bcrypt = require("bcrypt")  //importing bcrypt package to hash password and compare the hashed password
const validator = require("validator")
const crypto = require("crypto")
const nodemailer = require("nodemailer")
const Role = require("../roles/roleCreateModel")
